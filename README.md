...
| 6 | Haciendo lo tuyo: habilidades (opcional, privada) | [`spec6-habilidades.md`](docs/spec6-habilidades.md) | plan |

Fuera del temario, como plan: [`operacion.md`](docs/operacion.md) — saber cuándo se rompe.
